...
export async function processRefineRequest(
	...
	channelId: number,
	apiKey: string,
	broadcastUpdate: (cId: number, mId: number, update: { status: string, modelUrl: string | null }) => void
	...
	// 5. Resume Polling
	resume3DGeneration(db, channelId, messageId, asset.id, asset.prompt, broadcastUpdate, () => { }, 'refined')
