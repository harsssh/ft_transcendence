    ...
    <Container>
      <ScrollArea h="100vh" type="always">
        ...
        <Text>
          ...
          the "Service"). By using the Service, users are deemed to have agreed
          to all provisions of these Terms.
        </Text>
        <Space h="lg" />
        <Title order={2}>2. Eligibility</Title>
        <Text>
          The Service is intended for individuals who can agree to these Terms
          on their own responsibility. Minors must obtain the consent of a
          parent or legal guardian before using the Service.
        </Text>
        <Space h="lg" />
        ...
        <ul>
          <li>
            <Text>
              The Service provider assumes no liability for any damages
              resulting from the use of an account by a third party.
            </Text>
          </li>
        </ul>
        <Space h="lg" />
        ...
        <ul>
          <li>
            <Text>
              Actions that violate laws, regulations, or public order and
              morals.
            </Text>
          </li>
          <li>
        ...
        <Text>
          ...
          provider shall not be held liable for any damages incurred by users as
        ...
        <Text>
          ...
          make no warranties, express or implied, regarding its accuracy or
          usefulness.
        </Text>
        <ul>
          <li>
