  ...
  return (
    <Container>
      ...
      <Text>
        ...
        guarantee the absolute integrity or security of the information. Please
        refrain from providing sensitive personal information or using passwords
        that are reused from other services.
      </Text>
      <Space h="lg" />
